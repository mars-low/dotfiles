...
user=$(whoami)
LS="#[fg=$G04,bg=$TC,bold] $user_icon #{pane_current_path} #[fg=$TC,bg=$G06,nobold]$right_arrow_icon#[fg=$TC,bg=$G06] $session_icon #S #(gitmux -cfg $HOME/.gitmux.conf #{pane_current_path})"
